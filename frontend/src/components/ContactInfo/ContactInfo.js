              ...
              <ul>
                <li className="youtube">
                  <a href="https://www.youtube.com/channel/UChuhEhCujTGP1mfmPdtuVhA" target="_blank" rel="noopener noreferrer" aria-label="youtube channel">
                    <svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="youtube" className="svg-inline--fa fa-youtube fa-w-18 social_icon" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
                      <path
                        fill="currentColor"
                ...
                <li className="github">
                  <a href="https://github.com/subzero783" target="_blank" rel="noopener noreferrer" aria-label="github">
                    <svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="github profile" className="svg-inline--fa fa-github fa-w-16 social_icon" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512">
                      <path
                        fill="currentColor"
                ...
                <li className="linkedin">
                  <a href="https://www.linkedin.com/in/subzero783-gustavo-amezcua/" target="_blank" rel="noopener noreferrer" aria-label="linkedin profile">
                    <svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="linkedin" className="svg-inline--fa fa-linkedin fa-w-14 social_icon" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                      <path
                        fill="currentColor"
