export const posts = [
  ...
  },
  {
    ...
    description: "The <!DOCTYPE> declaration is an important part of your HTML document that tells a web browser which version of HTML you are using. It is the first line of code and should be one of the very first things written into your HTML document.",
    date: "2023/09/13",
    author: "Developer Gus",
    categories: ["HTML"],
    content: "Hello, and welcome to this short article on the<!DOCTYPE> declaration in HTML5. The<!DOCTYPE> declaration is an important part of your HTML document that tells a web browser which version of HTML you are using. It is the first line of code and should be one of the very first things written into your HTML document. If you are writing in HTML5, the<!DOCTYPE> declaration should look like this:",
  },
];
