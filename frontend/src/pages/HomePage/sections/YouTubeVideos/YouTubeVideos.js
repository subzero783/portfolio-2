    ...
    <div id="developer-gus">
      <div className="container-lg">
        <div className="row">
          ...
          <div id="player-2">{<iframe src={`https://www.youtube-nocookie.com/embed/${posts[2].video_id}`} title={posts[1].title} allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>}</div>
