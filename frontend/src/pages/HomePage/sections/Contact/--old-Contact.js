              ...
              <div className="embed-form-container">
                <div id="mc_embed_shell">
                  <div id="mc_embed_signup">
                    <form action="https://developergus.us21.list-manage.com/subscribe/post?u=e40a569cd7df3b77266a0c5f0&amp;id=0045ca637a&amp;f_id=0005d4e6f0" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_self" novalidate="">
                      <div id="mc_embed_signup_scroll">
                        ...
                        <div aria-hidden="true" style={{ position: "absolute", left: "-5000px" }}>
                          <input type="text" name="b_e40a569cd7df3b77266a0c5f0_0045ca637a" tabindex="-1" value="" />
                        </div>
                        <div className="clear">
