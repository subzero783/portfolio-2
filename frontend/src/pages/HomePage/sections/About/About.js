...
const page_scroll_2 = () => {
  ...
  if (scrolled >= document.getElementById("about").offsetTop - 600 && scrolled < document.getElementById("services").offsetTop) {
                  ...
                  <Timeline
                    data={{
                      1: {
                        ...
                        description: "<ul> <li>I am responsible for developing client-side and front-end web applications using a variety of programming languages such as HTML, CSS, JavaScript, ReactJS, SCSS, PHP, and MySQL.</li><li>My goal is to create visually appealing and interactive websites that load quickly, utilizing different functionality programming languages like JavaScript and ReactJS.</li><li>I also ensure that the front-end of websites is user-friendly, SEO friendly, and compatible across different browsers and platforms.</li><li>In collaboration with back-end developers and designers, I brainstorm ideas to improve usability and meet client requirements.</li><li>Additionally, I prioritize coding standards, including making websites ADA compliant, and add any SEO that was requested, to ensure the highest quality in the pages and websites I develop.</li><li> Use the Adobe Creative Suite including PhotoShop and Illustrator and also use Figma to modify and optimize designs. Develop websites from the designs created on Figma files. Incorporate technical SEO and also put the users experience first when writing code. </li><li>Integrate websites into GitHub repositories and add automatic deployment with GitHub Actions. Including using version-control interface frameworks such as SourceTree. </li><li>Create, manage and update responsive/cross-browser compatible WordPress websites. Developed with ACF, REST APIs, JavaScript, ReactJS and CSS pre-processing frameworks (SASS/LESS). </li><li>Develop WordPress Gutenberg Blocks using ReactJS. </li><li>Document code by writing comments and instructions for content updates and also for other developers to have clear instructions. </li></ul>",
                      },
                      2: {
                        date: "2021 - 2022",
                        title: "Web Developer",
